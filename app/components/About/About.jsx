...
const About = () => {
  return (
    <div className="max-w-full  mx-auto  p-8 bg-gradient-to-r from-[#F0F7F6] to-[#e1e8e7] rounded-md shadow-lg text-black flex items-center">
      ...
      <Image
          src="/home.jpeg" // Adjust the path based on your project structure
          alt="about"
...
<p className="text-lg mb-4 text-justify">
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis asperiores facere nesciunt amet ratione labore ipsa eligendi ad incidunt? Expedita?
</p>
<p className="text-lg mb-4 text-justify">
  Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam quo molestiae perferendis quod aperiam doloribus.
</p>     
      </div>
